...
//        public UnityEngine.Object LoadResource(string abName, string resName, System.Type type)
//        {
//            //加载目标包
//            AssetBundle ab = LoadABPackage(abName);
...
//        /// <param name="resName">资源名称</param>
//        public void LoadResourceAsync(string abName, string resName, System.Action<UnityEngine.Object> finishLoadObjectHandler)
//        {
//            AssetBundle ab = LoadABPackage(abName);
//            //开启协程 提供资源加载成功后的委托
...
//        private IEnumerator LoadRes(AssetBundle ab, string resName, System.Action<UnityEngine.Object> finishLoadObjectHandler)
//        {
...
//        //根据Type异步加载资源
//        public void LoadResourceAsync(string abName, string resName, System.Type type, System.Action<UnityEngine.Object> finishLoadObjectHandler)
//        {
//            AssetBundle ab = LoadABPackage(abName);
...
//        private IEnumerator LoadRes(AssetBundle ab, string resName, System.Type type, System.Action<UnityEngine.Object> finishLoadObjectHandler)
//        {
//            if (ab == null) yield break;
...
//        //泛型加载
//        public void LoadResourceAsync<T>(string abName, string resName, System.Action<UnityEngine.Object> finishLoadObjectHandler) where T : UnityEngine.Object
//        {
//            AssetBundle ab = LoadABPackage(abName);
//            StartCoroutine(LoadRes<T>(ab, resName, finishLoadObjectHandler));
//        }

//        private IEnumerator LoadRes<T>(AssetBundle ab, string resName, System.Action<UnityEngine.Object> finishLoadObjectHandler) where T : UnityEngine.Object
//        {
//            if (ab == null) yield break;
